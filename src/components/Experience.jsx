...
const Experience = () => {
  return (
    <div className="border-b border-neutral-900 pb-4">
        ...
        className="my-20 text-center text-4xl text-black">Experience</motion.h1>
            ...
            <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                ...
                className="w-full max-w-xl lg:w-3/4">
                    <h6 className="mb-2 font-semibold text-black">{experience.role} -{" "} 
                        <span className="text-sm text-purple-800">{experience.company}</span></h6>
                ...
                {experience.technologies.map((tech,index)=>(
                    ...
                    font-medium text-white-800">{tech}</span>
                ))}
                </motion.div>
            </div>
            ))}
